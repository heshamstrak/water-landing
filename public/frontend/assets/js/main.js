(function($){
    ...
    $(".home-slides").on("translate.owl.carousel", function(){
        ...
        $(".home-slides span").removeClass("animate__animated animate__zoomIn").css("opacity", "0");
    ...
    $(".home-slides").on("translated.owl.carousel", function(){
        ...
        $(".home-slides span").addClass("animate__animated animate__zoomIn").css("opacity", "1");
...
function setTheme(themeName) {
	localStorage.setItem('walrus_theme', themeName);
	document.documentElement.className = themeName;
}
// function to toggle between light and dark theme
function toggleTheme() {
	if (localStorage.getItem('walrus_theme') === 'theme-dark') {
