...
<div class="card card-custom gutter-b">
    <div class="card-header flex-wrap py-3">
        ...
        <div class="card-toolbar">
            ...
            <div>
                <?php if(auth()->user()->hasPermission('read_'.$name)): ?>
                    <a href="<?php echo e(route('admin.'.$name.'.create')); ?>" class="btn btn-primary font-weight-bolder">
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
            ...
            let testimonialsTable = $('#<?php echo e($name); ?>-table').DataTable({
                dom: "tiplr",
                serverSide: true,
                processing: true,
                ajax: {
        ...
        $('#data-table-search').keyup(function () {
            testimonialsTable.search(this.value).draw();
        })
    </script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/water-landing/resources/views/admin/testimonials/index.blade.php ENDPATH**/ ?>