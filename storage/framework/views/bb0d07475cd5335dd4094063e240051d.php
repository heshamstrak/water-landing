...
<?php $__env->startPush('js'); ?>
    ...
    <script>
            ...
            let skillTable = $('#<?php echo e($name); ?>-table').DataTable({
                dom: "tiplr",
                serverSide: true,
                processing: true,
                ajax: {
        ...
        $('#data-table-search').keyup(function () {
            skillTable.search(this.value).draw();
        })
    </script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/water-landing/resources/views/admin/skills/index.blade.php ENDPATH**/ ?>