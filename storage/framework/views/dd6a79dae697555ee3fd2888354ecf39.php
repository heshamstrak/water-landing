...
<div class="card card-custom gutter-b">
    <div class="card-header flex-wrap py-3">
        ...
        <div class="card-toolbar">
            ...
            <div>
                <form method="post" action="<?php echo e(route('admin.contacts.bulk_delete')); ?>" style="display: inline-block;">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        let aboutsTable = $('#<?php echo e($name); ?>-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            ajax: {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/water-landing/resources/views/admin/contacts/index.blade.php ENDPATH**/ ?>