...
<?php $__env->startPush('js'); ?>
    ...
    <script>
            ...
            let differentsTable = $('#<?php echo e($name); ?>-table').DataTable({
                dom: "tiplr",
                serverSide: true,
                processing: true,
                ajax: {
        ...
        $('#data-table-search').keyup(function () {
            differentsTable.search(this.value).draw();
        })
    </script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/water-landing/resources/views/admin/differents/index.blade.php ENDPATH**/ ?>