            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-5">
                        <ul>
                            <?php if(setting('facebook') != null): ?><li><a href="<?php echo e(setting('facebook')); ?>"><i class="icofont-facebook"></i></a></li><?php endif; ?>
                            <?php if(setting('twitter') != null): ?><li><a href="<?php echo e(setting('twitter')); ?>"><i class="icofont-twitter"></i></a></li><?php endif; ?>
                            <?php if(setting('instagram') != null): ?><li><a href="<?php echo e(setting('instagram')); ?>"><i class="icofont-instagram"></i></a></li><?php endif; ?>
                            <?php if(setting('linkedin') != null): ?><li><a href="<?php echo e(setting('linkedin')); ?>"><i class="icofont-linkedin"></i></a></li><?php endif; ?>
                            <?php if(setting('youtube') != null): ?><li><a href="<?php echo e(setting('youtube')); ?>"><i class="icofont-youtube"></i></a></li><?php endif; ?>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Mixitup Min JS -->
        <script src="<?php echo e(asset('frontend/assets')); ?>/js/mixitup.min.js"></script>
        <!-- Particles Min JS -->
        ...
        <script>
              $(document).ready(function() {
                ...
                $('#newsletters').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route("newsletters.store")); ?>',
                        data: formData,
                        success: function(response) {
                            console.log(response);
    ...
    </body><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/water-landing/resources/views/layouts/frontend/_footer.blade.php ENDPATH**/ ?>