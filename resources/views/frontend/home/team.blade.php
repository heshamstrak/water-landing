        ...
        <div class="row">
            <div class="team-slides owl-carousel owl-theme">
                <div class="col-lg-12 col-md-12">
                    <div class="team-box">
                        <img src="{{asset('frontend/assets')}}/img/team-img1.jpg" alt="team-image">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-box">
                        <img src="{{asset('frontend/assets')}}/img/team-img2.jpg" alt="team-image">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-box">
                        <img src="{{asset('frontend/assets')}}/img/team-img3.jpg" alt="team-image">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-box">
                        <img src="{{asset('frontend/assets')}}/img/team-img4.jpg" alt="team-image">
