<section id="contact" class="contact-area ptb-100 bg-image">
    <div class="container">
        <div class="section-title">
            <span>{{setting('main_title_contact')}}</span>
            <h2>{{setting('title_contact')}}</h2>
            <p>{{setting('description_contact')}}</p>  
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                ...
                <div class="contact-info">
                    <ul>
                        <li><i class="icofont-google-map"></i> {{setting('address')}}</li>
                        <li><i class="icofont-envelope"></i> <a href="#"><span class="__cf_email__" data-cfemail="e99e88859b9c9aa98e84888085c78a8684">{{setting('email')}}</span></a></li>
                        <li><i class="icofont-phone"></i> <a href="#">{{setting('phone')}}</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="contact-form">
                    ...
                    <form id="contactForm2" action="{{route('contact.store')}}" method="post">
                        @csrf
                        <div class="row">
