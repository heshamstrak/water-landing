...
<html lang="en" >
   ...
   <head>
      ...
      <!--end::Layout Themes-->
      <link href="{{asset('admin_assets')}}/css/pages/wizard/wizard-2.css" rel="stylesheet" type="text/css"/>
...
=======
                  <img alt="Logo" src="{{Storage::url('public/uploads/settings/'.setting('logo_image'))}}" style="width:188px"/>
>>>>>>> 5ef127c (update)
                  </a>
                  <!--end::Logo-->
                  <!--begin::Toggle-->
