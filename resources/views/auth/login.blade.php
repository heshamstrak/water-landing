...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('admin_assets')}}/css/pages/login/login-3.css?v=7.0.6" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                ...
                <div class="login-aside d-flex flex-column flex-row-auto">
                    ...
                    <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                        ...
                        <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                            <img src="{{Storage::url('public/uploads/settings/'.setting('logo_image'))}}" class="max-h-100px" alt=""  style="width: 400px"/>
                        </a>
                        <!--end::Aside header-->
                    ...
                    <!--begin::Aside Bottom-->
                    <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url({{asset('admin_assets')}}/media/svg/illustrations/login-visual-5.svg);"></div>
                    <!--end::Aside Bottom-->
                </div>
                <!--begin::Aside-->
                        ...
                        <div class="login-form">
                            ...
                            <form class="form" action="{{ route('login') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control h-auto py-7 px-6 rounded-lg border-0" type="text" @error('email') is-invalid @enderror name="email" required autocomplete="off" value="{{old('email')}}"/>
                                </div>
                                <!--end::Form group-->
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control h-auto py-7 px-6 rounded-lg border-0" type="password" @error('password') is-invalid @enderror name="password" required autocomplete="off" />
                                </div>
                                <!--end::Form group-->
        ...
        <script src="{{asset('admin_assets')}}/js/pages/custom/login/login-3.js?v=7.0.6"></script>
        <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
</html>
