...
<<<<<<< HEAD:resources/views/admin/products/index.blade.php
                                <th>Image</th>
                                <th>Name</th>
                                <th>Category</th>
                                <th>Count</th>
...
=======
                                <th>Title</th>
                                <th>Image</th>
>>>>>>> 5ef127c (update):resources/views/admin/services/index.blade.php
                                <th>Created at</th>
                                <th>Action</th>
                            </tr>
                        </thead>
...
@push('js')
    ...
    <script>
            ...
            let servicesTable = $('#{{$name}}-table').DataTable({
                dom: "tiplr",
                serverSide: true,
                processing: true,
                ajax: {
